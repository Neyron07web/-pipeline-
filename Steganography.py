...
def batch_process():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Примеры:
  python Steganography.py --mode encode --input image.png --message "СЕКРЕТ"
  python Steganography.py --mode decode --input encoded.png  
  python Steganography.py --mode analyze --input image.png
        """
    )
